...
-- =====================================================
-- CORREÇÃO: Manter vínculo admin-usuário após aceitação
-- =====================================================
...
BEGIN
    ...
    ELSE
        ...
        INSERT INTO public.profiles (
            ...
            v_footer_text_primary, v_footer_text_secondary, true
        );
    END IF;
    ...
    -- CRÍTICO: Atualizar convite mantendo vínculo admin-usuário
...
-- Criar convite retroativo para perfil 012
...
VALUES (
    '2e8c3825-703c-42c8-be7c-1c41653df64c',
    'b103aed1-feea-49af-ae04-27a2c2296581',
    'b103aed1-feea-49af-ae04-27a2c2296581',
    'accepted',
    NOW(),
    gen_random_uuid(),
